...
<td valign="top"> <!-- #BeginEditable "maincontent" --> 
                  ...
                  <p class="space" align="center"><a href="/arrangement/index2.asp"><img src="<%=getImage(rsArr("frontpage_img"),"3")%>"></a></p>
                  <p class="space" align="center"><a href="/arrangement/index2.asp">Se 
                    Programmet</a></p>
					<% 
					rsArr.MoveNext
					wend
