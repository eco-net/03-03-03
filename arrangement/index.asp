...
'while not rsNew.EOF
%>
<!--                        <a href="index.asp?id=<%'=rsNew("id")%>"><%'=rsNew("title")%></a><br> -->
                        <br>
                        <%' rsNew.MoveNext
'wend
'end if
%>
            ...
            <table width="90%" border="0" cellspacing="0" cellpadding="0" align="center">
              <tr> 
                <td> 
                  <p><a href="/forening/about_2.asp">Bliv medlem</a> af foreningen 'Mad&nbsp;&amp;&nbsp;Musik -&Oslash;kologi&nbsp;&amp;&nbsp;Kultur'<br>
                  ...
                  <table width="90%" border="0" cellspacing="0" cellpadding="0" align="center">
                    <tr> 
                      <td> 
						...
						'while not rsOld.EOF %>
   <!--                     <br><a href="index.asp?id=<%'=rsOld("id")%>"><%'=rsOld("title")%></a><br> -->
